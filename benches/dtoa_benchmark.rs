...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("3.14159 -> raw (display_float raw)", |b| b.iter(|| raw::ftod(black_box(3.14159f64))));
    ...
    c.bench_function("3.14e10 -> raw (display_float raw)", |b| b.iter(|| raw::ftod(black_box(3.14e10))));
    ...
    c.bench_function("13124014 -> raw (display_float raw)", |b| b.iter(|| raw::ftod(black_box(13124014f64))));
}
